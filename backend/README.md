...
## Project Structure
    ...
    ├── testapiautosetting_125697  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125697`
...
2. Clone this repo and `cd testapiautosetting_125697`
